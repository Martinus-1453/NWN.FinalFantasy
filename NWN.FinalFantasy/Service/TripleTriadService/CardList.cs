    ...
    public static class CardList
    {
        public static Dictionary<CardType, Card> Create()
        {
            return new Dictionary<CardType, Card>()
            {
                ...
                {CardType.Cockatrice, new Card("Cockatrice", "Card_P_Cockatric", 2, 2, 6, 1, CardElementType.Lightning)},
                ...
                {CardType.Anacondaur, new Card("Anacondaur", "Card_P_Anacondau", 5, 3, 5, 1, CardElementType.Poison)},
                {CardType.Creeps, new Card("Creeps", "Card_P_Creeps", 5, 5, 2, 2, CardElementType.Lightning)},
                {CardType.Grendel, new Card("Grendel", "Card_P_Grendel", 4, 5, 2, 4, CardElementType.Lightning)},
                ...
                {CardType.Armadodo, new Card("Armadodo", "Card_P_Armadodo", 6, 1, 6, 3, CardElementType.Earth)},
                {CardType.TriFace, new Card("Tri-Face", "Card_P_Tri-Face", 3, 5, 5, 5, CardElementType.Poison)},
                {CardType.Fastitocalon, new Card("Fastitocalon", "Card_P_Fast1", 7, 1, 3, 5, CardElementType.Earth)},
                {CardType.SnowLion, new Card("Snow Lion", "Card_P_SnowLion", 7, 5, 3, 1, CardElementType.Ice)},
                {CardType.Ochu, new Card("Ochu", "Card_P_Ochu", 5, 3, 3, 6)},
                {CardType.Sam08G, new Card("SAM08G", "Card_P_SAM08G", 5, 2, 4, 6, CardElementType.Fire)},
                {CardType.DeathClaw, new Card("Death Claw", "Card_P_DeathClaw", 4, 7, 2, 4, CardElementType.Fire)},
                {CardType.Cactuar, new Card("Cactuar", "Card_P_Cactuar", 6, 3, 2, 6)},
                {CardType.Tonberry, new Card("Tonberry", "Card_P_Tonberry", 3, 4, 4, 6)},
                {CardType.AbyssWorm, new Card("Abyss Worm", "Card_P_AbyssWorm", 7, 3, 5, 2, CardElementType.Earth)},
                ...
                {CardType.Bomb, new Card("Bomb", "Card_P_Bomb", 2, 6, 3, 7, CardElementType.Fire)},
                {CardType.Blitz, new Card("Blitz", "Card_P_Blitz", 1, 4, 7, 6, CardElementType.Lightning)},
                ...
                {CardType.BlueDragon, new Card("Blue Dragon", "Card_P_BlueDrago", 6, 7, 3, 2, CardElementType.Poison)},
                {CardType.Adamantoise, new Card("Adamantoise", "Card_P_Adamantoi", 4, 5, 6, 5, CardElementType.Earth)},
                {CardType.Hexadragon, new Card("Hexadragon", "Card_P_Hexadrago", 7, 4, 3, 5, CardElementType.Fire)},
                ...
                {CardType.Chimera, new Card("Chimera", "Card_P_Chimera", 6, 3, 2, 6, CardElementType.Water)},
                ...
                {CardType.RubyDragon, new Card("Ruby Dragon", "Card_P_RubyDrago", 7, 7, 4, 2, CardElementType.Fire)},
                ...
                {CardType.Elvoret, new Card("Elvoret", "Card_P_Elvoret", 7, 3, 4, 8, CardElementType.Wind)},
                ...
                {CardType.Quezacotl, new Card("Quezacotl", "Card_P_Quezacotl", 2, 9, 4, 9, CardElementType.Lightning)},
                {CardType.Shiva, new Card("Shiva", "Card_P_Shiva", 6, 4, 9, 7, CardElementType.Ice)},
                ...
                {CardType.Sacred, new Card("Sacred", "Card_P_Sacred", 5, 9, 9, 1, CardElementType.Earth)},
                {CardType.Minotaur, new Card("Minotaur", "Card_P_Minotaur", 9, 2, 9, 5, CardElementType.Earth)},
                ...
                {CardType.Alexander, new Card("Alexander", "Card_P_Alexander", 9, 4, 2, 10, CardElementType.Holy)},
                ...
                {CardType.Doomtrain, new Card("Doomtrain", "Card_P_Doomtrain", 3, 10, 10, 1, CardElementType.Poison)},
